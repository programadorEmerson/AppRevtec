...
class Automotiva extends StatefulWidget {
  @override
  _AutomotivaState createState() => _AutomotivaState();
}

class _AutomotivaState extends State<Automotiva> {
  ...
  Stream<QuerySnapshot> _listnerAutomotiva() {
    Firestore db = Firestore.instance;
    final stream = db
        .collection("produtos")
        .where("linha", isEqualTo: "Linha Automotiva")
        //.orderBy("nome")
        .snapshots();
    stream.listen((dados) {

...
class AntesDepois extends StatefulWidget {
  @override
  _AntesDepoisState createState() => _AntesDepoisState();
}

class _AntesDepoisState extends State<AntesDepois> {
                    ...
                    if (snapshot.hasError) {
                      ...
                      if (querySnapshot.documents.length == 0) {
                        ...
                        return LayoutBuilder(builder: (context, constraint) {
                          double fontSizeNome = Textos.size(
                            constraint.maxWidth * 0.07,
                            min: 8,
                            max: 16,
                          );
                          double fontSizeMensagem = Textos.size(
                            constraint.maxWidth * 0.07,
                            min: 8,
                            max: 14,
                          );
                          double fontSizeLida = Textos.size(
                            constraint.maxWidth * 0.07,
                            min: 8,
                            max: 14,
                          );
                          return ListView.separated(
                              ...
                              itemBuilder: (context, indice) {
                                ...
                                if (item["ordem"] == 0) {
                                  ...
                                  _icone = Icon(Icons.add_circle_outline,
                                      size: 20, color: _cor);
                                  ...
                                  _cor = Color(0xff075E54);
                                  _icone =
                                      Icon(Icons.eject, size: 20, color: _cor);
                                } else if (item["ordem"] == 2) {
                                  _notificacao = "Sua mensagem foi lida";
                                  _font = FontWeight.bold;
                                  _cor = Color(0xff075E54);
                                  _icone =
                                      Icon(Icons.check, size: 20, color: _cor);
                                }

                                return Stack(
                                  children: <Widget>[
                                    Padding(
                                      padding: EdgeInsets.fromLTRB(0, 4, 8, 2),
                                      child: Container(
                                        decoration: BoxDecoration(
                                            borderRadius:
                                                  ...
                                                  children: <Widget>[
                                                    Expanded(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: (){
                                                            Navigator.pushNamed(context, "/zoom", arguments: item["antes"]);
                                                          },
                                                          child: Container(
                                                            width: double.infinity,
                                                            child: Column(
                                                    ...
                                                    Expanded(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: GestureDetector(
                                                          onTap: (){
                                                            Navigator.pushNamed(context, "/zoom", arguments: item["depois"]);
                                                          },
                                                          child: Container(
                                                            width: double.infinity,
                                                            child: Column(
  ...
  _buscarProduto() {
    ...
    if (nomeDoProduto.isNotEmpty) {
      setState(() {
        _nomeProduto = nomeDoProduto
            .substring(0, nomeDoProduto.indexOf(" "))
            .toLowerCase();
      });
      ...
      Util.flutterNotification(
          ...
          // posição
          "${Util.primeiroNomeUsuarioLogado}",
          // Titulo
          "Informe um contato",
          // Texto
          Icon(Icons.info_outline, size: 25, color: Colors.green.shade300),
          // Icone
          Colors.black,
          // Cor de Fundo
          Colors.black,
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: new RaisedButton(
                                          ...
                                          onPressed: () async {
                                            Navigator.of(context).pop();
                                            _adicionarListenerProdutosNome(
                                                _nomeProduto);
                                          },
                                        ),
                                      )

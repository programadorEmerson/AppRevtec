...
class ItensPedidoRevtec extends StatefulWidget {
  String idPedido;
  ItensPedidoRevtec(this.idPedido);

  @override
  _ItensPedidoRevtecState createState() => _ItensPedidoRevtecState();
}

class _ItensPedidoRevtecState extends State<ItensPedidoRevtec> {
  ...
  void _concluir() {
    showDialog(
      ...
      builder: (_) => CupertinoAlertDialog(
        title: Text("Concluir Pedido"),
        content: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Text("Encerrar este pedido?"),
        ),
        actions: <Widget>[
          ...
          CupertinoDialogAction(
            ...
            onPressed: () {              
              Firestore db = Firestore.instance;
              db.collection("pedidosEnviados")
              .document(widget.idPedido)
              .updateData({"status": "Encerrado"}); 
              Util.enviarMensagem(Util.idUsuarioClicado, Util.idDaRevtec, "Olá, acabamos de finalizar seu pedido.", "texto", "");

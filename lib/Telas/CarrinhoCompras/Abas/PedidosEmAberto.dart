...
class PedidosEmAberto extends StatefulWidget {
  @override
  _PedidosEmAbertoState createState() => _PedidosEmAbertoState();
}

class _PedidosEmAbertoState extends State<PedidosEmAberto> {
  ...
  Stream<QuerySnapshot> _adicionarListenerProdutos() {
    ...
    final stream = db
        .collection("pedidos")
        .document(Util.idDooPedidoEmAberto)
        .collection("itens")
        .snapshots();
    stream.listen((dados) {
  ...
  _calcularCarrinho() async {
    ...
    for (DocumentSnapshot item in querySnapshot.documents) {
      valor = double.parse(Util.prepararValoresParaCalculo(item["preco"], context));
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: <Widget>[
                                                                              Expanded(
                                                                                ...
                                                                                child: GestureDetector(
                                                                                  onTap: () {
                                                                                    ...
                                                                                    _apresentacao = item["apresentacao"].toString();
                                                                                    _caracteristicaProduto = item["caracteristica"].toString();
                                                                                    _idProduto = item["idProduto"].toString();
                                                                                    _indicacoes = item["indicacoes"].toString();
                                                                                    _linhaProduto = item["linha"].toString();
                                                                                    _litragem = double.parse(item["litragem"].toString());
                                                                                    _modoDeUsar = item["modoDeUsar"].toString();
                                                                                    _nomeProduto = item["nome"].toString();
                                                                                    _precoRecuperado = item["preco"].toString();
                                                                                    _quantidade = item["quantidade"].toString();
                                                                                    _quantidadeDeCaixasDoPedido = item["quantidadeCaixas"].toString();
                                                                                    _urlPdfBoletim = item["urlBoletim"].toString();
                                                                                    _urlImagem = item["urlImagem"].toString();
                                                                                    _urlImagemZoom = item["urlZoom"].toString();

                                                                                    });
                                                                                    _transformarLitragem(item["litragem"].toString());
                                                                                    _Novaquantidade();
                                                                                  },
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Container(
                                                                                      width: double.infinity,
                                                                                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(32), color: Color(0xff075E54)),
                                                                                      child: Center(
                                                                                        child: Text(
                                                                                          "Alterar Qtdade",
                                                                                          style: TextStyle(
                                                                              ...
                                                                              Expanded(
                                                                                ...
                                                                                child: GestureDetector(
                                                                                  onTap: () {
                                                                                    db.collection("pedidos").document(Util.idDooPedidoEmAberto).collection("itens").document(item["idProduto"]).delete();
                                                                                    Toast.show("Item deletado", context, duration: Toast.LENGTH_LONG, gravity: Toast.CENTER);
                                                                                  },
                                                                                  child: Padding(
                                                                                    padding: EdgeInsets.only(right: 1, left: 1),
                                                                                    child: Container(
                              ...
                              children: <Widget>[
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Valor do pedido: " +
                                          Util.prepararValoresParaExibir(
                                              _preco.toString()) +
                                          "\nVolume total: " +
                                        ...
                                        onPressed: () {
                                          if (_preco > 1) {
                                            Util.flutterNotification(context,
                                                ...
                                                "Por favor aguarde estamos salvando seu pedido..", // Texto
                                                Icon(Icons.warning, size: 25, color: Colors.green.shade300), // Icone
                                                Colors.black, // Cor de Fundo
                                                Colors.black, // Cor da barra lateral
                                                Duration(seconds:3));                                            
                                            ...
                                            Util util = new Util();
                                            PedidoId pedidoComprador = new PedidoId();
                                            pedidoComprador.idPedido = Util.idDooPedidoEmAberto;
                                            pedidoComprador.dataPedido = util.dataAtual();
                                            pedidoComprador.status = "Finalizado";
                                            pedidoComprador.idLoja = Util.idDaRevtec;
                                            pedidoComprador.idComprador = Textos.idUsuarioLogado;
                                            pedidoComprador.nomeComprador = Textos.nomeUsuarioLogado;
                                            pedidoComprador.urlImagem = Textos.urlUsuario;
                                            
                                            db
                                              .collection("pedidosEnviados")
                                              .document(Util.idDooPedidoEmAberto)
                                              .setData(pedidoComprador.toMap());

                                              Util.flutterNotification(context,
                                                FlushbarPosition.BOTTOM, // posição
                                                Textos.nomeUsuarioLogado, // Titulo
                                                "Pedido enviado com sucesso..", // Texto
                                                Icon(Icons.warning, size: 25, color: Colors.green.shade300), // Icone
                                                Colors.black, // Cor de Fundo
                                                Colors.black, // Cor da barra lateral
                                                Duration(seconds:3));   
                                                Util.idDooPedidoEmAberto = "nao";
                                                Util.enviarMensagem(Util.idDaRevtec, Textos.idUsuarioLogado, "Olá, acabei de fazer um pedido com vocês.", "texto", "");

                                                db
                                                  .collection("pedidos")
                                                  .document(Textos.idUsuarioLogado)
                                                  .updateData({"idPedidoEmAberto": "nao"});
                                            ...
                                            Util.flutterNotification(
                                                ...
                                                FlushbarPosition
                                                    .BOTTOM, // posição
                                                "Ops ${Util.primeiroNomeUsuarioLogado}!!!", // Titulo
                                                "Seu carrinho de compras está vazio.", // Texto
                                                Icon(Icons.info_outline,
                                                    size: 25,
                                                    color: Colors.green
                                                        .shade300), // Icone
  ...
  _calcularQuantidade(int quantidade) {
    ...
    String qtdadeDeCaixa = ((int.parse(_controllerProduto.text) / _qtdadePorCaixa))
    .toString().substring(0,((int.parse(_controllerProduto.text) / _qtdadePorCaixa))
    .toString().indexOf("."));
    ...
    if (restoDivisao != 0) {
      ...
      int quantidadeQueFalta = _qtdadePorCaixa - (_qtdadePorCaixa - restoDivisao);
      ...
      setState(() {
          _quantidadeDeItensDoPedido = (int.parse((_qtdadePorCaixa - quantidadeQueFalta).toString())+int.parse(_controllerProduto.text)).toString();
        });
  ...
  _comprar() async {
    ...
    produto.nome = _nomeProduto.toLowerCase().trim();

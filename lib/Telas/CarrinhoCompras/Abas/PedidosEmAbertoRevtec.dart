...
class PedidosEmAbertoRevtec extends StatefulWidget {
  @override
  _PedidosEmAbertoRevtecState createState() => _PedidosEmAbertoRevtecState();
}

class _PedidosEmAbertoRevtecState extends State<PedidosEmAbertoRevtec> {
                    ...
                    if (querySnapshot.documents.length == 0) {
                      ...
                      return ListView.separated(
                          ...
                          itemBuilder: (context, indice) {
                            ...
                            if (item["status"] == "Finalizado" && Textos.souARevtec) {
                              _status = "Novo Pedido";
                            } else {
                              _status = "Finalizado";
                            }
                            ...
                            return Container(
                              ...
                              child: GestureDetector(
                                onTap: ()  async{
                                    Util.idUsuarioClicado = item["idComprador"];
                                    Navigator.pushNamed(context, "/itensRevtec", arguments: item["idPedido"]);
                                },
                                child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Container(
                                              ...
                                              child: Textos.souARevtec ? Text("Status do Pedido: "+_status,
                                                  style: TextStyle(
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.bold,
                                                    //color: Color(0xff075E54)
                                                  )) : Text("Status do Pedido: "+_status,
                                                  style: TextStyle(
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.bold,
                                                    //color: Color(0xff075E54)
